                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Marquee(child: Text(widget.data.displayName.validate(), style: boldTextStyle(size: 18))).flexible(),
                        8.width,
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(" ${widget.data.providersServiceRating.validate().toStringAsPrecision(2)}", style: secondaryTextStyle(size: 12, weight: FontWeight.bold)),
                      ],
                    ),
                    Center(
                      child: TextButton(
                        ...
                        child: Text(language.whyChooseMe, style: boldTextStyle(color: primaryColor)),
                      ),
